...
public class RendererWolk implements ISimpleBlockRenderingHandler {
	...
	public void drawOutSide(int x, int y, int z, Block block,
			RenderBlocks renderer) {
		Tessellator tessellator = Tessellator.instance;
	...
	public void drawHandles(int x, int y, int z, Block block,
			RenderBlocks renderer) {
		Tessellator tessellator = Tessellator.instance;
	...
	public void drawBottom(int x, int y, int z, Block block,
			RenderBlocks renderer) {
		Tessellator tessellator = Tessellator.instance;
