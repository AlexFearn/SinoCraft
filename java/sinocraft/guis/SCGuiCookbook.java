...
public class SCGuiCookbook extends GuiScreen
{
    ...
    private SCGuiCookbook.NextPageButton field_146470_A;
    private SCGuiCookbook.NextPageButton field_146471_B;
    ...
    public SCGuiCookbook(EntityPlayer par1EntityPlayer, ItemStack par2ItemStack, boolean par3)
    {
    ...
    public void initGui()
    {
        ...
        byte b0 = 2;
        this.field_146292_n.add(this.field_146470_A = new SCGuiCookbook.NextPageButton(1, i + 120, b0 + 154, true));
        this.field_146292_n.add(this.field_146471_B = new SCGuiCookbook.NextPageButton(2, i + 38, b0 + 154, false));
        this.func_146464_h();
    }
    ...
    static class NextPageButton extends GuiButton
        {
            ...
            public void func_146112_a(Minecraft p_146112_1_, int p_146112_2_, int p_146112_3_)
            {
                if (this.field_146125_m)
                {
                    ...
                    GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
                    p_146112_1_.getTextureManager().bindTexture(SCGuiCookbook.field_146466_f);
                    int k = 0;
                    int l = 192;
